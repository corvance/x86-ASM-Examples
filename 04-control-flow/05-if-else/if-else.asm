...
section .data
	...
	sy_string db "See you later!", 0x0A ; 0x0A = newline character.
	sy_len equ $ - sy_string
...
_start:
	...
	; else
printgw:
	mov ecx, sy_string           ; Load gw_string address into ecx.
	mov edx, sy_len              ; Load gw_len (length of "Gooodbye, World!\n") into edx.
